...
const homeSeasons = {
  spring: {
    ...
    leadTwo: "春季首頁適合從花開始，因為花會把老牆、屋瓦、柴堆與人的腳步重新串起來。這個網站也從這裡出發，把故鄉老屋、翔勝養蜂、茶行創業與捷運工程人生，一頁一頁安放回土地。"
  },
  summer: {
    bodyClass: "summer",
    ...
    leadTwo: "夏季首頁放一扇打開的窗，像是邀請人走近老屋。窗裡有家人的笑，窗外有山風、農忙、蜂箱與一日比一日濃的光，日子就在這樣的熱度裡長大。"
  },
  autumn: {
    bodyClass: "autumn",
    ...
    leadTwo: "秋季首頁留給相聚。屋前一排人影，比任何裝飾都更像收成：走過茶行、工程與蜂場，再回頭看老屋，才知道成熟不是抵達終點，而是把一路上的辛苦整理成可以分享的味道。"
  },
  winter: {
    bodyClass: "winter",
    ...
    leadTwo: "冬季首頁不必太熱鬧，它適合回望。看工程現場、看蜂場花期、看茶香與老物件，也看見一個家如何在山海之間把時間留下，等下一個春天再慢慢開門。"
  }
};
...
const articleItems = [
  {
    ...
    tag: "台北花博勤務",
    category: "engineering",
    summary: "從花博入口合影、展區花景到勤務視角，記下台北首次申辦世界花卉博覽會時，一位公共工程人站在現場看見的秩序、責任與家庭記憶。",
